...
function [w1_next,w2_next,p1_next,p2_next,e1,e2] = efk_training_y_dynamic(H,z_now,v_now,zn_now,vn_now,w1_now,w2_now,p1_now,p2_now,q1,q2,r1,r2)
    ...
    e_k = [x1 - x1n, x2 - x2n];
    eta = [0.4, 0.4]; % Si cambio el learning rate también cambia las ganancias necesarias
