% --- CONTROL NEURONAL PITCH ---
function [e1k, e2k, u_next] = control_rhonn_feedback_pitch(theta, w_y, phi, w_x, w_z, theta_next, w_y_next, phi_next, w_x_next, w_z_next, w1, w2, dt, Iwx, Iwu, ref, ref_next, ref_two_next)
    x1k = theta;
    x1k_1 = theta_next;
    x2k   = w_y;
    x2k_1 = w_y_next;
